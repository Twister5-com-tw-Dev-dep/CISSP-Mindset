...
D4 --> D4a["功率分析 (Power Analysis)"]
D4 --> D4b["時間分析 (Timing Attack)"]
D4 --> D4c["電磁波洩漏 (EM Leak)"]

B2 --> D5["彩虹表 (Rainbow Table)"]
D5 --> D5a["防禦：加鹽 (Salt)"]
D5 --> D5b["防禦：胡椒 (Pepper)"]
...
B2 --> D7["針對人攻擊 (Social Engineering)"]
D7 --> D7a["賄賂 (Bribery)"]
D7 --> D7b["拷問 / 橡皮管攻擊"]
(Cryptanalysis)] --> B1[密碼分析攻擊 (Cryptoanalytic Attacks)]
A1 --> B2[密碼學攻擊 (Cryptographic Attacks)]
